 ...
 * others -- quarantine, relocate, compress, archive, hardlink -- arrive with
 * the features that specify them (B1, B2, B4, B5, F4), each as one more entry
 * in this table and nothing else. `execute` refuses a kind that is not listed
